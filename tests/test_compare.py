...
class Test:
    ...
    def test_for_weapon(change_db, ship, true_weapon):
        change_weapon = change_db.select(name_table='Ships', key='ship',
        ...
        data_change = change_db.select(name_table='Weapons', key='weapon',
    ...
    def test_for_hull(change_db, ship, true_hull):
        change_hull = change_db.select(name_table='Ships', key='ship',
        ...
        data_change = change_db.select(name_table='Hulls', key='hull', condition=change_hull)
    ...
    def test_for_engine(change_db, ship, true_engine):
        change_engine = change_db.select(name_table='Ships', key='ship',
        ...
        data_change = change_db.select(name_table='Engines',
